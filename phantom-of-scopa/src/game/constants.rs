...
pub const POPUP_BG: Color = Color::rgba(0.11, 0.13, 0.13, 0.92);
pub const MENU_BG: Color = Color::rgba(0.11, 0.13, 0.13, 1.0);
pub const TEXT_COLOR: Color = Color::rgba(0.85, 0.82, 0.16, 1.0);
pub const INACTIVE_UI: Color = Color::rgba(0.60, 0.66, 0.24, 1.0);
pub const ACTIVE_UI: Color = Color::rgba(0.85, 0.82, 0.16, 1.0);
pub const INTERACTED_UI: Color = Color::rgba(0.65, 0.05, 0.06, 1.0);
